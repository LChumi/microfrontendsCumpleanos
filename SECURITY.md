...
Actualmente mantenemos soporte de seguridad únicamente para la rama principal (`master`).
...
Si encuentras una vulnerabilidad en microfrontendsCumpleanos, por favor repórtala de la siguiente manera:
...
Gracias por ayudarnos a mantener microfrontendsCumpleanos seguro y confiable.
